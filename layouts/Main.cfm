<cfoutput>
	...
	<head>
		<meta charset="utf-8">
		<title>Welcome to The Hero Registry!</title>
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50" style="padding-top: 60px">
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" role="navigation">
			<!---Brand --->
			<a class="navbar-brand mb-0" href="#event.buildLink('heroes')#"><strong>Home</strong></a>
		...
		<!---Container And Views --->
		<div class="container">#wirebox.getInstance("FlashMessage@flashmessage").render()#</div>
